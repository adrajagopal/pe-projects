...
<h2 class="xl-voice">Education</h2>

<h3 class="large-voice">Perpetual Education - Design for the Web</h3>

<p class="medium-voice">Design for the Web, 2023</p>
<p class="medium-voice">Not your average frontend bootcamp.</p>

<h3 class="large-voice">University of Florida, Gainesville</h3>

<p class="medium-voice">BA Economics, Cum Laude, 2015</p>

<!-- Skill section -->

<h2 class="xl-voice">Skills</h2>
